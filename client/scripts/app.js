...
app.addMessage = function(message) {
  if (message.username === app.friend){
    $('#chats').append('<div class = "chat friend"><div class = username>' + message.username + '</div><div>' + message.text + '</div></div>');
  }
  else {
    $('#chats').append('<div class = chat><div class = username>' + message.username + '</div><div>' + message.text + '</div></div>');
  }
  $('.chat').off();
